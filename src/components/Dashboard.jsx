  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div
        ...
        } sm:block w-full sm:w-64 bg-white shadow-lg`}
      >
        <div className="p-4">
        ...
        <div className="mt-6 p-4">
          <h2 className="text-sm font-semibold text-gray-500">Your teams</h2>
      ...
      <div className="flex-1 p-3">
        ...
        <div className="w-full rounded-xl bg-white p-4 flex justify-between items-center shadow-md relative">
          {/*Search input */}
        ...
        <div>
          <div>
            <div className="flex justify-between items-center lg:px-6 md:px-4 px-2">
              <h2 className="lg:text-5xl md:text-3xl text-2xl font-bold md:my-10 my-5">
                Task Plan
              </h2>
